<?php
namespace Tistory;
define('API_URL', 'https://www.tistory.com/apis/');
...
class Api {
    ...
    private function request_post($url, $param)
    {
        ...
        curl_setopt($curl_handle, CURLOPT_HTTPHEADER, \Setting\HEADERS);
    ...
    public function get_authcode()
    {
        ...
        return "<script>location.href='https://www.tistory.com/oauth/authorize/?client_id=".$this->client_id."&redirect_uri=".$this->redirect_url."&response_type=".$this->response_type."';</script>";
    }

    public function post_write($title, $content, $tag, $category)
    {
        if( $this->access_token == "" ) return false;
        $url = API_URL . "post/write";
